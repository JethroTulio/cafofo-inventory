...
export const Dashboard: React.FC<DashboardProps> = ({
  ...
  return (
    <div className="space-y-5 pb-12">
      ...
      {/* Cards de KPIs Principais (Com fontes ampliadas e legíveis no Celular) */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">

        {/* Total Financeiro da Casa */}
        <div className="bg-gradient-to-br from-brand-600 to-brand-700 rounded-xl sm:rounded-2xl p-3.5 sm:p-5 text-white shadow-md shadow-brand-600/10 flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-xs sm:text-xs font-bold uppercase tracking-wider text-brand-100">Patrimônio</span>
            <div className="p-1.5 sm:p-2 bg-white/10 backdrop-blur-md rounded-lg sm:rounded-xl">
              <DollarSign className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
            </div>
          </div>
          <div className="mt-2.5 sm:mt-4">
            <h2 className="text-base sm:text-2xl font-black tracking-tight truncate">{formatBRL(valorTotalCasa)}</h2>
            <p className="hidden sm:block text-xs text-brand-100/90 mt-1 font-medium">Soma total registrada</p>
          </div>
        </div>

        {/* Quantidade Total de Itens */}
        <div className="bg-white rounded-xl sm:rounded-2xl p-3.5 sm:p-5 border border-slate-200 shadow-sm flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-xs sm:text-xs font-bold uppercase tracking-wider text-slate-500">Itens</span>
          ...
          <div className="mt-2.5 sm:mt-4">
            <h2 className="text-base sm:text-2xl font-black text-slate-900 tracking-tight">
              {totalItensCount} <span className="text-xs font-semibold text-slate-500">objetos</span>
            </h2>
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl p-3.5 sm:p-5 border border-slate-200 shadow-sm flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-xs sm:text-xs font-bold uppercase tracking-wider text-slate-500">Locais</span>
          ...
          <div className="mt-2.5 sm:mt-4">
            <h2 className="text-base sm:text-2xl font-black text-slate-900 tracking-tight">
              {locais.length} <span className="text-xs font-semibold text-slate-500">imóveis</span>
            </h2>
        ...
        <div
          ...
          className={`rounded-xl sm:rounded-2xl p-3.5 sm:p-5 border shadow-sm cursor-pointer transition flex flex-col justify-between ${
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-xs sm:text-xs font-bold uppercase tracking-wider text-slate-600">Validade</span>
          ...
          <div className="mt-2.5 sm:mt-4">
            <h2 className="text-base sm:text-2xl font-black text-slate-900 tracking-tight">
              {itensVencidos.length + itensProximosVencer.length} <span className="text-xs font-semibold text-slate-500">alertas</span>
            </h2>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200 pb-3">
          ...
          <div className="flex items-center bg-slate-100 p-1 rounded-xl w-full sm:w-auto">
            <button
              ...
              className={`flex-1 sm:flex-none px-4 py-2.5 rounded-lg text-xs font-bold transition flex items-center justify-center gap-1.5 ${
                activeTab === 'locais'
