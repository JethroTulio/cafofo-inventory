    ...
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-sm">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-2 sm:gap-4">
          ...
          {/* Logo & Marca Oficial (Exibido com destaque no celular e computador) */}
          <div className="flex items-center gap-2 cursor-pointer shrink-0" onClick={() => setActiveView('dashboard')}>
            ...
            <div className="flex flex-col">
              <span className="text-xs sm:text-base font-black text-slate-900 tracking-tight block leading-none">
                Cafofo <span className="text-brand-600">Inventory</span>
              </span>
              <span className="text-[8px] sm:text-[10px] text-slate-400 font-bold uppercase tracking-wider block leading-tight mt-0.5">
          ...
          <div className="flex-1 max-w-xl relative">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-8 py-1.5 sm:py-2 bg-slate-100 hover:bg-slate-100/80 focus:bg-white border border-transparent focus:border-brand-500 rounded-full text-xs sm:text-sm text-slate-900 placeholder-slate-400 transition focus:outline-none focus:ring-2 focus:ring-brand-500/20"
              />
              <button
                type="button"
          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            <button
              ...
              className="flex items-center gap-1.5 p-2 sm:px-3 sm:py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold rounded-xl transition"
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1 px-2.5 sm:px-3.5 py-2 bg-brand-600 hover:bg-brand-700 text-white text-xs font-semibold rounded-xl shadow-sm transition"
              >
            ...
            <button
              ...
              className="p-1.5 sm:p-2 text-slate-600 hover:text-slate-900 hover:bg-slate-100 rounded-xl transition"
            ...
            <button
              ...
              className="p-1.5 sm:p-2 text-slate-600 hover:text-amber-600 hover:bg-amber-50 rounded-xl transition"
